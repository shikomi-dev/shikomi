...
| [`sub-f-cli-subcommands/index.md`](./sub-f-cli-subcommands/index.md) | Sub-F (#44) shikomi-cli vault サブコマンド + 既存 CRUD ロック時挙動 + 保護モードバナー + アクセシビリティ + **TC-F-E01 田中ペルソナ E2E**（Sub-E TC-E-E01 凍結シナリオの実機完走、Sub-F CLI 完成後）— Issue #75 関連は [`issue-75-verification.md`](./sub-f-cli-subcommands/issue-75-verification.md)、Issue #76 (#74-B) ユニット 13 件 工程3+4 SSoT は [`issue-76-verification.md`](./sub-f-cli-subcommands/issue-76-verification.md) | `TC-F-{U,I,A,E,S}*` |
...
| Sub-F | **39**（unit 15 + integration 12 + accessibility 5 + E2E 1 + static 6、Rev1 で TC-F-U13 + TC-F-A05 + TC-F-S06 追加 / Issue #75 (#74-A) で TC-F-U08/U09 追加 + 旧 U08/U09 を U14/U15 にリナンバ） | `sub-f-cli-subcommands/{index,issue-75-verification,issue-76-verification}.md`（Issue #75 工程2 内部レビュー [ペガサス指摘] でディレクトリ分割、Issue #76 工程2 で issue-76-verification.md 追加）|
| **合計** | **191**（Issue #75 (#74-A) で Sub-F +2 TC、189 → 191）| — |
