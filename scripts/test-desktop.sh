...
export GSETTINGS_BACKEND=dconf LIBGL_ALWAYS_SOFTWARE=1
...
dbus-update-activation-environment XDG_DATA_HOME XDG_CONFIG_HOME XDG_CACHE_HOME XDG_RUNTIME_DIR XDG_SESSION_TYPE XDG_CURRENT_DESKTOP GDK_BACKEND WAYLAND_DISPLAY GSETTINGS_BACKEND GTK_IM_MODULE XMODIFIERS LANG LC_ALL
