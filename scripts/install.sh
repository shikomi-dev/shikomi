...
install -d "$data/shikomi/gui" "$data/applications" "$data/icons/hicolor/scalable/apps"
...
install -m 644 "$root/packaging/io.github.shikomi.shikomi_gui.svg" "$data/icons/hicolor/scalable/apps/"
